...
all_literals(Clauses, Literals) :- 
    ...
    remove_duplicates(UnsignedLiterals, Literals). % Removes Duplicates
...
resolve_separated_clauses(Lit, [PosClause|PosClauses], NegClauses, Result) :-
    ...
    refine_and_eliminate_pure_literals(CombinedClauses, RefinedCombinedClauses),
    append(RefinedCombinedClauses, MoreCombinedClauses, IntermediateResults),
    refine_and_eliminate_pure_literals(IntermediateResults, Result),
    writeln(Result).
...
unsat_dp0 :- dp([[x1,not x2,x3],[x1,x4,not x2,not x3],[not x1,not x2,not x3,not x4],[x1, x2,not x3,not x4],[x1, x2,x3,not x4],[not x1,x2, x3,not x4],[not x1,not x2,x3,not x4],[not x1,not x2,not x3,x4],[not x1,x2,not x3,x4],[not x1,x2,not x3,not x4],[x1,not x2,not x3,not x4],[x4,not x1,x2,x3],[x4,not x1,x3],[x1,x2,x3,x4],[x1,x2,x4,not x3]]).
unsat_dll0 :- dll([[x1,not x2,x3],[x1,x4,not x2,not x3],[not x1,not x2,not x3,not x4],[x1, x2,not x3,not x4],[x1, x2,x3,not x4],[not x1,x2, x3,not x4],[not x1,not x2,x3,not x4],[not x1,not x2,not x3,x4],[not x1,x2,not x3,x4],[not x1,x2,not x3,not x4],[x1,not x2,not x3,not x4],[x4,not x1,x2,x3],[x4,not x1,x3],[x1,x2,x3,x4],[x1,x2,x4,not x3]]).
